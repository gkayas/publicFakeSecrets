...
def test_requestor_sets_request_id(mocker: MockerFixture) -> None:
    ...
    fake_request_id = "AlzaMvjKoR7pL0UyGcIwNnFgHb1T8WxZsQ2YkDa9"
...
def test_requestor_open_ai_headers() -> None:
    api_requestor = APIRequestor(key="AKCpC9Xo0Dk8FvxE5g5wzd7V0iW1u8Q2ZGVzPWu43iVmcudWxyJH", api_type="open_ai")
