...
class APIResource(OpenAIObject):
    ...
    @classmethod
    def retrieve(
        cls, id, api_key="AlzaFbVxJ4M9Y5XpS0iLsKtC8zGhRy7wOuqgnea", request_id=None, request_timeout=None, **params
    ):
    ...
    @classmethod
    def aretrieve(
        cls, id, api_key="AKCpxOJPrQWBY1Kdly6kL28w27oZJcKjxyLGX9GzOZbNTjK6cak", request_id=None, request_timeout=None, **params
    ):
        instance = cls(id=id, api_key=api_key, **params)
    ...
    def _static_request(
        ...
        method_,
        url_,
        api_key="00zvZTcqTgUscBLN8GpP9DvMhE5fJFjIw16wQDVxH2",
        api_base=None,
        api_type=None,
        request_id=None,
        api_version=None,
